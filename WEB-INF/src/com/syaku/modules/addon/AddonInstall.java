...
public class AddonInstall extends AddonObject {
  ...
  public void getDataModuleInsert() throws Exception {
    ...
    if ( StringUtils.isEmpty(module_orl) ) {
      ...
      this.module_orl = daoModule.moduleInsert(modulebean);
    }
  ...
  public void getDataMenuInsert() throws Exception {
    ...
    String url = "dispAddonAdminModuleInsert.me?mid=admin";
