/*
 * CommentInstall.java 2011.01.01
 *
...
public class CommentInstall extends CommentObject {
  ...
  public void getTableCreate() throws Exception {
    ...
    sqlCommentCreate(null);
    sqlCommentCreateCounter(null);
    sqlCommentCreateSns(null);
  ...
  public void getDataMenuInsert() throws Exception {
    ...
    String url = "dispCommentAdminInsert.me?mid=admin";
