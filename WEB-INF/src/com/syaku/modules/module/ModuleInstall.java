...
public class ModuleInstall extends ModuleObject {
  ...
  public void getTableCreate() throws Exception {
    sqlModuleCreate(null);
    sqlModuleOptionsCreate(null);
    sqlModuleGrantsCreate(null);
  ...
  public void getDataMenuInsert() throws Exception {
    ...
    String url = "dispModuleAdminList.me?mid=admin";
